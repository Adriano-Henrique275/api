...
const DoctorController_1 = __importDefault(
  require("./infra/controller/DoctorController")
);
const PatientController_1 = __importDefault(
  require("./infra/controller/PatientController")
);
